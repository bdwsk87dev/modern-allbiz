                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('admin.accounts')" :active="route().current('admin.accounts')">
                                Аккаунты
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.customers')" :active="route().current('admin.customers')">
                                Клиенты (Customers)
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.campaigns')" :active="route().current('admin.campaigns')">
                              Кампании
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.customers_history')" :active="route().current('admin.customers_history')">
                              История клиентов
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.campaigns_history')" :active="route().current('admin.campaigns_history')">
                              История кампаний
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.checker_history')" :active="route().current('admin.checker_history')">
                                Еженедельный лог
                            </jet-nav-link>
                            <jet-nav-link :href="route('admin.daily_checker_history')" :active="route().current('admin.daily_checker_history')">
                                Ежедневный лог
                            </jet-nav-link>
                        </div>
                    </div>
