                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg pt-4 pb-4">
                    <div class="align-middle inline-block min-w-full overflow-hidden bg-white shadow-dashboard px-8 pt-3">
                        ...
                        <div class="sm:flex-1 sm:flex sm:items-center sm:justify-between work-sans">
                            ...
                            <div class="sm:flex-1 sm:flex sm:items-center sm:justify-between work-sans">
                              <div>
                                <select v-on:change="changeFilterErrorType($event)" class="p-1.5 bg-gray-100">
                                  <option data-filter="all">Все</option>
                                  <option data-filter="processed">Только processed</option>
                                  <option data-filter="warning">Только warnings</option>
                                  <option data-filter="error">Только errors</option>
                                </select>
                              </div>
                        ...
                        <table class="min-w-full" >
                            ...
                            <tr>
                                ...
                                <th @click="changeSort('task')"
                                    class="cursor-pointer px-3 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">
                                    <div class="inline-flex">
                                        <div class="inline-block">Task</div>
                                        <div class="inline-block min-w-16px">{{ sortIconShow('task') }}</div>
                                    </div>
                                </th>
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr v-for="log of logs" >
                                    ...
                                    <td class="px-3 py-2  border-b text-blue-900 border-gray-500 text-sm leading-5 w-60">
                                        {{ log.task }}
                                    </td>
...
export default {
    ...
    methods: {
        ...
        changeFilterErrorType(e){
          if(e.target.options.selectedIndex > -1) {
            let errorType = e.target.options[e.target.options.selectedIndex].dataset.filter;
            this.filter.messageType = errorType;
            this.getLogs();
